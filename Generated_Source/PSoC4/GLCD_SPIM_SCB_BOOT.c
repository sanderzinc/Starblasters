/*******************************************************************************
* File Name: GLCD_SPIM_SCB_BOOT.c
* Version 1.0
*
* Description:
...
#if defined(CYDEV_BOOTLOADER_IO_COMP) && ((CYDEV_BOOTLOADER_IO_COMP == CyBtldr_GLCD_SPIM_SCB) || \
                                          (CYDEV_BOOTLOADER_IO_COMP == CyBtldr_Custom_Interface))

/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_CyBtldrCommStart
********************************************************************************
*
* Summary:
...
void GLCD_SPIM_SCB_CyBtldrCommStart(void)
{
        ...
        {
            GLCD_SPIM_SCB_I2CCyBtldrCommStart();
        }
        else if(GLCD_SPIM_SCB_SCB_MODE_SPI_RUNTM_CFG)
        {
            GLCD_SPIM_SCB_SpiCyBtldrCommStart();
        }
        else if(GLCD_SPIM_SCB_SCB_MODE_UART_RUNTM_CFG)
        {
            GLCD_SPIM_SCB_UartCyBtldrCommStart();
        }
        else
        {
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_CyBtldrCommStop
********************************************************************************
*
* Summary:
...
void GLCD_SPIM_SCB_CyBtldrCommStop(void)
{
        ...
        if(GLCD_SPIM_SCB_SCB_MODE_I2C_RUNTM_CFG)
        {
            GLCD_SPIM_SCB_I2CCyBtldrCommStop();
        }
        else if(GLCD_SPIM_SCB_SCB_MODE_SPI_RUNTM_CFG)
        {
            GLCD_SPIM_SCB_SpiCyBtldrCommStop();
        }
        else if(GLCD_SPIM_SCB_SCB_MODE_UART_RUNTM_CFG)
        {
            GLCD_SPIM_SCB_UartCyBtldrCommStop();
        }
        else
        {
            /* Unknown mode: do nothing */
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_CyBtldrCommReset
********************************************************************************
*
* Summary:
...
void GLCD_SPIM_SCB_CyBtldrCommReset(void)
{
        ...
        if(GLCD_SPIM_SCB_SCB_MODE_I2C_RUNTM_CFG)
        {
            GLCD_SPIM_SCB_I2CCyBtldrCommReset();
        }
        else if(GLCD_SPIM_SCB_SCB_MODE_SPI_RUNTM_CFG)
        {
            GLCD_SPIM_SCB_SpiCyBtldrCommReset();
        }
        else if(GLCD_SPIM_SCB_SCB_MODE_UART_RUNTM_CFG)
        {
            GLCD_SPIM_SCB_UartCyBtldrCommReset();
        }
        else
        {
            /* Unknown mode: do nothing */
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_CyBtldrCommRead
********************************************************************************
*
* Summary:
...
cystatus GLCD_SPIM_SCB_CyBtldrCommRead(uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    cystatus status;
        ...
        if(GLCD_SPIM_SCB_SCB_MODE_I2C_RUNTM_CFG)
        {
            status = GLCD_SPIM_SCB_I2CCyBtldrCommRead(pData, size, count, timeOut);
        }
        else if(GLCD_SPIM_SCB_SCB_MODE_SPI_RUNTM_CFG)
        {
            status = GLCD_SPIM_SCB_SpiCyBtldrCommRead(pData, size, count, timeOut);
        }
        else if(GLCD_SPIM_SCB_SCB_MODE_UART_RUNTM_CFG)
        {
            status = GLCD_SPIM_SCB_UartCyBtldrCommRead(pData, size, count, timeOut);
        }
        else
        {
...
/*******************************************************************************
* Function Name: GLCD_SPIM_SCB_CyBtldrCommWrite
********************************************************************************
*
* Summary:
...
cystatus GLCD_SPIM_SCB_CyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    cystatus status;
        ...
        if(GLCD_SPIM_SCB_SCB_MODE_I2C_RUNTM_CFG)
        {
            status = GLCD_SPIM_SCB_I2CCyBtldrCommWrite(pData, size, count, timeOut);
        }
        else if(GLCD_SPIM_SCB_SCB_MODE_SPI_RUNTM_CFG)
        {
            status = GLCD_SPIM_SCB_SpiCyBtldrCommWrite(pData, size, count, timeOut);
        }
        else if(GLCD_SPIM_SCB_SCB_MODE_UART_RUNTM_CFG)
        {
            status = GLCD_SPIM_SCB_UartCyBtldrCommWrite(pData, size, count, timeOut);
        }
        else
        {
            status = CYRET_INVALID_STATE; /* Unknown mode: return status */
