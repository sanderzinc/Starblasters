...
#define GLCD_SPIM_SCB_ss0_m_DM_ALG_HIZ         (0x00u << GLCD_SPIM_SCB_ss0_m_DRIVE_MODE_SHIFT)
#define GLCD_SPIM_SCB_ss0_m_DM_DIG_HIZ         (0x01u << GLCD_SPIM_SCB_ss0_m_DRIVE_MODE_SHIFT)
#define GLCD_SPIM_SCB_ss0_m_DM_RES_UP          (0x02u << GLCD_SPIM_SCB_ss0_m_DRIVE_MODE_SHIFT)
#define GLCD_SPIM_SCB_ss0_m_DM_RES_DWN         (0x03u << GLCD_SPIM_SCB_ss0_m_DRIVE_MODE_SHIFT)
#define GLCD_SPIM_SCB_ss0_m_DM_OD_LO           (0x04u << GLCD_SPIM_SCB_ss0_m_DRIVE_MODE_SHIFT)
#define GLCD_SPIM_SCB_ss0_m_DM_OD_HI           (0x05u << GLCD_SPIM_SCB_ss0_m_DRIVE_MODE_SHIFT)
#define GLCD_SPIM_SCB_ss0_m_DM_STRONG          (0x06u << GLCD_SPIM_SCB_ss0_m_DRIVE_MODE_SHIFT)
#define GLCD_SPIM_SCB_ss0_m_DM_RES_UPDWN       (0x07u << GLCD_SPIM_SCB_ss0_m_DRIVE_MODE_SHIFT)
...
#if defined(GLCD_SPIM_SCB_ss0_m__INTSTAT)  /* Interrupt Registers */
